...
class iamai:
    ...
    def img_shuffle(self):
        ...
        return self.img_test, self.img_val, self.img_test, self.y_train, self.y_val, self.y_test
    ...
    def create_model(self):
        # 모델 생성
        # 128, 128
        self.model.add(Conv2D(16, (5, 5), padding='same', activation='relu', input_shape=(128, 128, 1)))
    ...
    def training_model(self):
        ...
        #                               batch_size=128)
        self.history = self.model.fit(self.img_train, self.y_train_encoded, epochs=1000,
                                      validation_data=(self.img_val, self.y_val_encoded),
                                      batch_size=128)
        print("학습 종료")
